...
export const loginUserSchema = z.object({
	email: z.string({ required_error: 'Required' }).email({ message: 'Email must be a valid email' }),
	password: z.string({ required_error: 'Reuired' })
});
...
export const registerUserSchema = z
	.object({
		name: z
			...
			.regex(/^[a-zA-Z\s]*$/, { message: 'Name can only contain letters nad spaces' })
